...
global $CFG;
require_once($CFG->dirroot.'/cohortrestricted/lib.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_cohortrestricted_lib_testcase extends advanced_testcase {

    /**
     * Test that a new group with the name of the cohort is created.
     */
    public function test_enrol_cohortrestricted_create_new_group() {
        global $DB;
        $this->resetAfterTest();
        // Create a category.
        ...
        // Run the function.
        $groupid = enrol_cohortrestricted_create_new_group($course->id, $cohort->id);
        // Check the results.
        ...
        $groupid = enrol_cohortrestricted_create_new_group($course2->id, $cohort->id);
